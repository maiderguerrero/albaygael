	...
	reporterosusademoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Icono 1 estrella', element: 'span', attributes: { 'class': 'icon icon-una-estrella' } },
				{ name: 'Icono 2 estrellas', element: 'span', attributes: { 'class': 'icon icon-dos-estrellas' } },
				{ name: 'Icono 3 estrellas', element: 'span', attributes: { 'class': 'icon icon-tres-estrellas' } },
